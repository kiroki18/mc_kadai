...
static std::unique_ptr<ExprAST> ParseIfExpr() {
    ...
    return llvm::make_unique<IfExprAST>(std::move(branch_cond),std::move(then_exp),std::move(else_exp));
}
